  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">Basic reports for your assigned vehicles</p>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
          ...
          <div className="space-y-3">
            ...
            {topSpeeds.length === 0 && <p className="text-sm text-slate-400">No report data available.</p>}
          </div>
        </div>
