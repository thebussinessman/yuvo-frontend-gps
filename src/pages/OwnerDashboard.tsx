...
type Page = 'fleet' | 'tracking' | 'playback' | 'reports' | 'users' | 'profile';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">Track your fleet in real time — click a car on the map or the list</p>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.65fr_1fr]">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
          <h3 className="mb-4 text-lg font-semibold text-white">Fleet Vehicles</h3>
          ...
          {loading ? (
            ...
            <div className="space-y-2">
              ...
              {fleet.length === 0 && <p className="text-sm text-slate-400">No vehicles found.</p>}
            </div>
          )}
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">Replay any vehicle's history</p>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">Historical distance, speed, and idle time for your fleet</p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5">
        <h3 className="mb-4 text-base font-semibold text-white">Fleet summary</h3>
